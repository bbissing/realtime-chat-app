...
const UnseenChatToast: FC<UnseenChatToastProps> = ({
  ...
  return (
    <div
      className={cn(
        'max-w-md w-full bg-white shadow-lg rounded-lg pointer-auto flex ring-1 ring-black ring-opacity-5',
      ...
      className='flex-1 w-0 p-4'>
        <div className='flex items-start'>
          ...
          <div className='ml-3 flex-1'>
            ...
            <p className='mt-1 text-sm texty-gray-500'>{senderMessage}</p>
          </div>
        </div>
      </a>
